...
print_banner() {
  printf("\nNBTscan version 1.5.2. Copyright (C) 2008 Portcullis .\n");
...
int main(int argc, char *argv[]) {
  int timeout=1000, verbose=0, use137=0, ch, dump=0, bandwidth=0, send_ok=0, hr=0, etc_hosts=0, lmhosts=0, total=0;
  extern char *optarg;
  extern int optind;
  char* target_string;
  char* sf=NULL;
  ...
  if(bandwidth) send_interval.tv_usec = 
    ...
    send_interval.tv_usec = 1000; /* for 10baseT interval should be about 1 ms */
